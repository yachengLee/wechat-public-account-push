...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      id: 'oPEpw52yG9KQJPOUulx_X2NtJksU',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      useTemplateId: 'iSvaeBzXHydCHsSVKYidPOHQTJ0MHqAupwSnzbB7Omw',
  ...
  CALLBACK_TEMPLATE_ID: 'iSvaeBzXHydCHsSVKYidPOHQTJ0MHqAupwSnzbB7Omw',
  CALLBACK_USERS: [
    {
      name: '自己',
